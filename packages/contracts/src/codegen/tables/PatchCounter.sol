...
library PatchCounter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "PatchCounter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746261707000000000000000000000005061746368436f756e74657200000000);
